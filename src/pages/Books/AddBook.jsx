...
const AddBook = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    thumbnail: Yup.mixed().required("Cover thumbnail is required"),
  });
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="space-y-2">
                ...
                >
                  {preview ? (
                    <div className="relative aspect-[3/4] h-48 rounded-xl overflow-hidden shadow-2xl">
                      <img
                        src={preview}
                        alt="Preview"
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 p-1 bg-red-500 text-white rounded-full hover:bg-red-600 transition-colors border-none cursor-pointer"
                      >
                        ×
                      </button>
                    </div>
