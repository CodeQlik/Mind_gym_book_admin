...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    { title: "Users", icon: <Users size={22} />, path: "/admin/users" },
    {
      title: "Subscribe",
      icon: <CreditCard size={22} />,
      path: "/admin/subscribe",
      subItems: [
        { title: "Plan", path: "/admin/subscribe" },
        { title: "Subscribe User", path: "/admin/subscribe/users" },
      ],
    },
    {
      title: "Payments",
    ...
    { title: "Coupons", icon: <Ticket size={22} />, path: "/admin/coupons" },
    { title: "Messages", icon: <Mail size={22} />, path: "/admin/messages" },
    {
      title: "CMS",
      icon: <FileText size={22} />,
      path: "/admin/cms",
      subItems: [
        { title: "About Us", path: "/admin/cms/edit/about-us" },
        { title: "Privacy Policy", path: "/admin/cms/edit/privacy-policy" },
        {
          title: "Terms & Conditions",
          path: "/admin/cms/edit/terms-conditions",
        },
        { title: "Refund Policy", path: "/admin/cms/edit/refund-policy" },
        { title: "FAQ", path: "/admin/cms/faqs" },
        { title: "Blog", path: "/admin/cms/blog" },
        { title: "Testimonials", path: "/admin/cms/testimonials" },
      ],
    },
    { title: "Support", icon: <LifeBuoy size={22} />, path: "/admin/support" },
    {
      title: "Settings",
